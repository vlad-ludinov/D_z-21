...
# Будем считать, что на вход подается
# только одно слово, которое содержит
...
englishLetters = {"A": 1, "E": 1, "I": 1, "O": 1, "U": 1, "L": 1, "N": 1, "S": 1, "T": 1, "R": 1,
                  ...
                  "J": 8, "X": 8,
                  "Q": 10, "Z": 10}
russianLetters = {"А": 1, "В": 1, "Е": 1, "И": 1, "Н": 1, "О": 1, "Р": 1, "С": 1, "Т": 1,
...
word = word.upper()
costWord = 0
if word[0] in englishLetters:
    for i in word:
        costWord += englishLetters.get(i)
elif word[0] in russianLetters:
    for i in word:
        costWord += russianLetters.get(i)
print(costWord)
